...
<thead>
  <tr>
    <th width=40%><img src="../product/poster1.jpg" width=500px height=700px></th>
    <td width=60%>
     ...
     <?php
      ...
      if (!$_SESSION['valid_user']){
        ...
        if ($row['stock'] == 0){
          ...
          echo "<button class='btnadd'><a href='" .$_SERVER['PHP_SELF']. "?buy=8' style='text-decoration: none; color:white; '><i class='fa fa-shopping-cart'></i> Add to Cart</a></ button>";
        }
