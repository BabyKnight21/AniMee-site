...
<thead>
  <tr>
    <th width=40%><img src="../product/wallpaper3.jpg" width=800px height=550px></th>
    <td width=60%>
    ...
    <tr><h1><?php echo $row['productname'];?></h1></tr>
      ...
      if (!$_SESSION['valid_user']){
        ...
        if ($row['stock'] == 0){
          ...
          echo "<button class='btnadd'><a href='" .$_SERVER['PHP_SELF']. "?buy=7' style='text-decoration: none; color:white; '><i class='fa fa-shopping-cart'></i> Add to Cart</a></ button>";
        }
