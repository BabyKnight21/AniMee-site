...
<thead>
  <tr>
    <th width=40%><img src="../product/casing3.jpg" width=350px height=550px></th>
    <td width=60%>
    <table height=300px style="padding:20px 20px 20px 20px">
      ...
      if (!$_SESSION['valid_user']){
        ...
        if ($row['stock'] == 0){
          ...
          echo "<button class='btnadd'><a href='" .$_SERVER['PHP_SELF']. "?buy=20' style='text-decoration: none; color:white; '><i class='fa fa-shopping-cart'></i> Add to Cart</a></ button>";
        }
