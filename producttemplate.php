...
<thead>
  <tr>
    ...
    <table height=300px style="padding:20px 20px 20px 20px">
      <tr><h1>1/7 Scale Figure of Shinobu Oshino -- GoodSmile Company</h1></tr>
      <tr>
        <td><h3>Manufacturer: GoodSmile Company </h3></td>
      </tr>
      <tr>
        <td><h3>Category: 1/7th Scale </h3></td>
      </tr>
      <tr>
        <td><h3>Sculptor: Ken Yokota </h3></td>
      </tr>
      <tr>
        <td><h3>Price: $150 </h3></td>
      </tr>
      <tr>
        <td><h3>Quantity: 2</h3></td>
      </tr>
      <tr>
